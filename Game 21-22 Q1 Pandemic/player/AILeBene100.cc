   ...
   */
   ...
   Dir moved_to_enemy(Unit u) {
    ...
    if (c.unit_id != -1 and not Unit_is_mine(c.unit_id)) {
      ...
      if (u.health < 25 and e.health > 40) return TOP;
      ++p_bottom;
      if (c.city_id != -1) {
        ++p_bottom;
    ...
    if (c.unit_id != -1 and not Unit_is_mine(c.unit_id)) {
      Unit e = unit(c.unit_id);
      if (u.health < 25 and e.health > 40) return BOTTOM;
      ++p_top;
      if (c.city_id != -1) {
        ++p_top;
    ...
    if (c.unit_id != -1 and not Unit_is_mine(c.unit_id)) {
      Unit e = unit(c.unit_id);
      if (u.health < 25 and e.health > 40) return LEFT;
      ++p_right;
      if (c.city_id != -1) {
        ++p_right;
    ...
    if (c.unit_id != -1 and not Unit_is_mine(c.unit_id)) {
      Unit e = unit(c.unit_id);
      if (u.health < 25 and e.health > 40) return RIGHT;
      ++p_left;
      if (c.city_id != -1) {
        ++p_left;
