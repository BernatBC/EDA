   ...
   */
   ...
   Dir moved_to_enemy(Unit u) {
    ...
    if (c.unit_id != -1 and not Unit_is_mine(c.unit_id)) {
      ...
      if (u.health < 25 and e.health > 40) e_bottom = 1;
      ++p_bottom;
      if (c.city_id != -1) {
        ++p_bottom;
    ...
    if (c.unit_id != -1 and not Unit_is_mine(c.unit_id)) {
      Unit e = unit(c.unit_id);
      if (u.health < 25 and e.health > 40) e_top = 1;
      ++p_top;
      if (c.city_id != -1) {
        ++p_top;
    ...
    if (c.unit_id != -1 and not Unit_is_mine(c.unit_id)) {
      Unit e = unit(c.unit_id);
      if (u.health < 25 and e.health > 40) e_right = 1;
      ++p_right;
      if (c.city_id != -1) {
        ++p_right;
    ...
    if (c.unit_id != -1 and not Unit_is_mine(c.unit_id)) {
      Unit e = unit(c.unit_id);
      if (u.health < 25 and e.health > 40) e_left = 1;
      ++p_left;
      if (c.city_id != -1) {
        ++p_left;
    ...
    if (p_bottom + p_top + p_left + p_right == 0 or e_top + e_bottom + e_left + e_right > 0) return NONE;
